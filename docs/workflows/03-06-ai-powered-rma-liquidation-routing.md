# AI-Powered RMA & Liquidation Routing
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **AI-Powered RMA & Liquidation Routing**. 
...
![Workflow Architecture](../../assets/workflows/03-06/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Returns Portal`, `AI Vision`, `WMS`, `Stripe`.
...
- **Returns Portal**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
...
- **Primary Action**: Records persisted or state updated across target platforms (Returns Portal, AI Vision).
...
- `Returns Portal API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
...
1. **Import Workflow**: Download [AI-Powered RMA & Liquidation Routing JSON](../../workflows/03-supply-chain/03_06_ai_powered_rma_liquidation_routing.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/03-supply-chain/03_06_ai_powered_rma_liquidation_routing.json)**
