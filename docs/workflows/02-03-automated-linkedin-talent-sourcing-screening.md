# Automated LinkedIn Talent Sourcing & Screening
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Automated LinkedIn Talent Sourcing & Screening**. 
...
![Workflow Architecture](../../assets/workflows/02-03/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `LinkedIn`, `Clearbit`, `AI`, `Calendly`.
...
- **Primary Action**: Records persisted or state updated across target platforms (LinkedIn, Clearbit).
...
1. **Import Workflow**: Download [Automated LinkedIn Talent Sourcing & Screening JSON](../../workflows/02-hr/02_03_automated_linkedin_talent_sourcing_screening.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/02-hr/02_03_automated_linkedin_talent_sourcing_screening.json)**
