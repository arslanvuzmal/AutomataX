# Community Forum to Bug Tracker Sync
...
Bugs reported by users in public community forums get lost or ignored, leading to frustrated power users and unresolved software defects.
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Community Forum to Bug Tracker Sync**. 
...
![Workflow Architecture](../../assets/workflows/04-05/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Discourse`, `Jira`.
...
- **Discourse**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
...
- **Primary Action**: Records persisted or state updated across target platforms (Discourse, Jira).
...
- `Discourse API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
...
1. **Import Workflow**: Download [Community Forum to Bug Tracker Sync JSON](../../workflows/04-customer-success/04_05_community_forum_to_bug_tracker_sync.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/04-customer-success/04_05_community_forum_to_bug_tracker_sync.json)**
