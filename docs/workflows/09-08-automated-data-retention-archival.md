...
Keeping years of raw log data in a high-performance Snowflake warehouse costs a fortune. DBA teams rarely have time to clean up old tables manually.
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Automated Data Retention & Archival**. 
...
![Workflow Architecture](../../assets/workflows/09-08/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Snowflake`, `Slack`.
...
- **Primary Action**: Records persisted or state updated across target platforms (Snowflake, Slack).
...
1. **Import Workflow**: Download [Automated Data Retention & Archival JSON](../../workflows/09-data-engineering/09_08_automated_data_retention_archival.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/09-data-engineering/09_08_automated_data_retention_archival.json)**
