...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **360-Degree Performance Review Aggregation**. 
...
![Workflow Architecture](../../assets/workflows/02-04/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Lattice`, `Slack`, `Notion`, `Sentiment Analysis AI`.
...
- **Sentiment Analysis AI**: Primary operational service responsible for data retrieval, state mutation, or record persistence.

---

## Outputs

- **Primary Action**: Records persisted or state updated across target platforms (Lattice, Slack).
...
- `Sentiment Analysis AI API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.

---

## Setup

1. **Import Workflow**: Download [360-Degree Performance Review Aggregation JSON](../../workflows/02-hr/02_04_360_degree_performance_review_aggregation.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/02-hr/02_04_360_degree_performance_review_aggregation.json)**
