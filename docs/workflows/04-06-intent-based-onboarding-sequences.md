# Intent-Based Onboarding Sequences
...
Sending generic, one-size-fits-all onboarding emails results in low engagement. Users only care about the features relevant to their specific use-case.
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Intent-Based Onboarding Sequences**. 
...
![Workflow Architecture](../../assets/workflows/04-06/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Chili Piper`, `Marketing Automation (e.g., Marketo/HubSpot)`.
...
- **Chili Piper**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
- **Marketing Automation (e.g., Marketo/HubSpot)**: Primary operational service responsible for data retrieval, state mutation, or record persistence.

---

## Outputs

- **Primary Action**: Records persisted or state updated across target platforms (Chili Piper, Marketing Automation (e.g., Marketo/HubSpot)).
...
- `Chili Piper API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
- `Marketing Automation (e.g., Marketo/HubSpot) API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.

---

## Setup

1. **Import Workflow**: Download [Intent-Based Onboarding Sequences JSON](../../workflows/04-customer-success/04_06_intent_based_onboarding_sequences.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/04-customer-success/04_06_intent_based_onboarding_sequences.json)**
