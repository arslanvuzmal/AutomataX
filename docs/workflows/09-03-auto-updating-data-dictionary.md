...
Data catalogs (like Atlan or Alation) go out of date instantly because engineers forget to document new schema columns.
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Auto-Updating Data Dictionary**. 
...
![Workflow Architecture](../../assets/workflows/09-03/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Snowflake`, `AI`, `Data Catalog (Atlan)`.
...
- **Data Catalog (Atlan)**: Primary operational service responsible for data retrieval, state mutation, or record persistence.

---

## Outputs

- **Primary Action**: Records persisted or state updated across target platforms (Snowflake, AI).
...
- `Data Catalog (Atlan) API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.

---

## Setup

1. **Import Workflow**: Download [Auto-Updating Data Dictionary JSON](../../workflows/09-data-engineering/09_03_auto_updating_data_dictionary.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/09-data-engineering/09_03_auto_updating_data_dictionary.json)**
