# Frictionless Internal Mobility & Transfers
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Frictionless Internal Mobility & Transfers**. 
...
![Workflow Architecture](../../assets/workflows/02-07/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Workday`, `Email/Slack`.
...
- **Primary Action**: Records persisted or state updated across target platforms (Workday, Email/Slack).
...
1. **Import Workflow**: Download [Frictionless Internal Mobility & Transfers JSON](../../workflows/02-hr/02_07_frictionless_internal_mobility_transfers.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/02-hr/02_07_frictionless_internal_mobility_transfers.json)**
