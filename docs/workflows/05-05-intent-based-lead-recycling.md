...
SDRs discard "Not Right Now" leads, and marketing rarely nurtures them effectively. When those prospects are ready to buy months later, they go to a competitor.
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Intent-Based Lead Recycling**. 
...
![Workflow Architecture](../../assets/workflows/05-05/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Salesforce`, `Marketo`.
...
- **Primary Action**: Records persisted or state updated across target platforms (Salesforce, Marketo).
...
1. **Import Workflow**: Download [Intent-Based Lead Recycling JSON](../../workflows/05-sales-crm/05_05_intent_based_lead_recycling.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/05-sales-crm/05_05_intent_based_lead_recycling.json)**
