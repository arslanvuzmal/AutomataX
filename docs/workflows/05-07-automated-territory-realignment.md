# Automated Territory Realignment
...
When a new rep is hired or territories are redrawn, Ops spends days manually exporting, mapping, and mass-updating account owners in the CRM.
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Automated Territory Realignment**. 
...
![Workflow Architecture](../../assets/workflows/05-07/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Salesforce`, `Email/Slack`.
...
- **Primary Action**: Records persisted or state updated across target platforms (Salesforce, Email/Slack).
...
1. **Import Workflow**: Download [Automated Territory Realignment JSON](../../workflows/05-sales-crm/05_07_automated_territory_realignment.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/05-sales-crm/05_07_automated_territory_realignment.json)**
