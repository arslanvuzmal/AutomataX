...
Marketing captures great user feedback in Intercom, but it never makes its way to the Product team's roadmap.
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Voice of Customer Feedback Loop**. 
...
![Workflow Architecture](../../assets/workflows/07-10/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Intercom`, `Productboard`, `AI`.
...
- **Primary Action**: Records persisted or state updated across target platforms (Intercom, Productboard).
...
1. **Import Workflow**: Download [Voice of Customer Feedback Loop JSON](../../workflows/07-marketing/07_10_voice_of_customer_feedback_loop.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/07-marketing/07_10_voice_of_customer_feedback_loop.json)**
