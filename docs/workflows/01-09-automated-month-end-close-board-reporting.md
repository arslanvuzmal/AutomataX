# Automated Month-End Close & Board Reporting
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Automated Month-End Close & Board Reporting**. 
...
![Workflow Architecture](../../assets/workflows/01-09/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Xero`, `Python`, `Excel generation`, `Secure Email`.
...
- **Python**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
- **Excel generation**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
- **Secure Email**: Primary operational service responsible for data retrieval, state mutation, or record persistence.

---

## Outputs

- **Primary Action**: Records persisted or state updated across target platforms (Xero, Python).
...
- `Python API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
- `Excel generation API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
- `Secure Email API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.

---

## Setup

1. **Import Workflow**: Download [Automated Month-End Close & Board Reporting JSON](../../workflows/01-finops/01_09_automated_month_end_close_board_reporting.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/01-finops/01_09_automated_month_end_close_board_reporting.json)**
