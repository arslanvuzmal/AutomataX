...
Marketers often call an A/B test a "winner" too early without calculating true statistical significance, leading to poor CRO decisions.
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Statistical A/B Test Decision Engine**. 
...
![Workflow Architecture](../../assets/workflows/07-09/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Optimizely`, `Python Scripting`, `CMS/Production System`.
...
- **Optimizely**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
- **Python Scripting**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
- **CMS/Production System**: Primary operational service responsible for data retrieval, state mutation, or record persistence.

---

## Outputs

- **Primary Action**: Records persisted or state updated across target platforms (Optimizely, Python Scripting).
...
- `Optimizely API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
- `Python Scripting API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
- `CMS/Production System API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.

---

## Setup

1. **Import Workflow**: Download [Statistical A/B Test Decision Engine JSON](../../workflows/07-marketing/07_09_statistical_a_b_test_decision_engine.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/07-marketing/07_09_statistical_a_b_test_decision_engine.json)**
