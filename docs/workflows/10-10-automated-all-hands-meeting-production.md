# Automated All-Hands Meeting Production
...
Producing a high-quality, monthly all-hands meeting requires gathering slides, writing scripts, and manually uploading the recording for employees who couldn't attend.
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Automated All-Hands Meeting Production**. 
...
![Workflow Architecture](../../assets/workflows/10-10/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Slack`, `Presentation API`, `Video Hosting API`.
...
- **Presentation API**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
- **Video Hosting API**: Primary operational service responsible for data retrieval, state mutation, or record persistence.

---

## Outputs

- **Primary Action**: Records persisted or state updated across target platforms (Slack, Presentation API).
...
- `Presentation API API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
- `Video Hosting API API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.

---

## Setup

1. **Import Workflow**: Download [Automated All-Hands Meeting Production JSON](../../workflows/10-executive/10_10_automated_all_hands_meeting_production.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/10-executive/10_10_automated_all_hands_meeting_production.json)**
