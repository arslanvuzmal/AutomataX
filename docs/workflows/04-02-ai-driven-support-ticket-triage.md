...
Support queues get clogged with low-priority or repetitive questions, delaying responses to critical P1 issues that impact major clients.
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **AI-Driven Support Ticket Triage**. 
...
![Workflow Architecture](../../assets/workflows/04-02/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Zendesk`, `AI`, `PagerDuty`.
...
- **Primary Action**: Records persisted or state updated across target platforms (Zendesk, AI).
...
1. **Import Workflow**: Download [AI-Driven Support Ticket Triage JSON](../../workflows/04-customer-success/04_02_ai_driven_support_ticket_triage.json) and import into n8n canvas.
...
- **Fixture Input**: `fixtures/inputs/04-02.json`
- **Expected Result**: `fixtures/expected/04-02.json`
...
📥 **[Download n8n Workflow JSON](../../workflows/04-customer-success/04_02_ai_driven_support_ticket_triage.json)**
