# Automated Ad Spend Pacing & Pause
...
Marketing agencies and internal teams frequently overspend their budgets on Meta or Google Ads because daily pacing is tracked in manual spreadsheets.
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Automated Ad Spend Pacing & Pause**. 
...
![Workflow Architecture](../../assets/workflows/07-03/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Meta Ads`, `Google Ads`, `LinkedIn Ads`, `Google Sheets`.
...
- **Meta Ads**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
- **Google Ads**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
- **LinkedIn Ads**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
- **Google Sheets**: Primary operational service responsible for data retrieval, state mutation, or record persistence.

---

## Outputs

- **Primary Action**: Records persisted or state updated across target platforms (Meta Ads, Google Ads).
...
- `Meta Ads API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
- `Google Ads API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
- `LinkedIn Ads API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
- `Google Sheets API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.

---

## Setup

1. **Import Workflow**: Download [Automated Ad Spend Pacing & Pause JSON](../../workflows/07-marketing/07_03_automated_ad_spend_pacing_pause.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/07-marketing/07_03_automated_ad_spend_pacing_pause.json)**
