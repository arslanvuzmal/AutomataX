...
Leads generated from Facebook or LinkedIn forms sit in a CSV file waiting to be downloaded, growing cold by the minute.
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Speed-to-Lead Ad Handoff**. 
...
![Workflow Architecture](../../assets/workflows/07-07/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Facebook Lead Ads`, `HubSpot`, `SMS API`.
...
- **Facebook Lead Ads**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
...
- **Primary Action**: Records persisted or state updated across target platforms (Facebook Lead Ads, HubSpot).
...
- `Facebook Lead Ads API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
...
1. **Import Workflow**: Download [Speed-to-Lead Ad Handoff JSON](../../workflows/07-marketing/07_07_speed_to_lead_ad_handoff.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/07-marketing/07_07_speed_to_lead_ad_handoff.json)**
