# Omnichannel Sales Aggregation & Data Warehousing
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Omnichannel Sales Aggregation & Data Warehousing**. 
...
![Workflow Architecture](../../assets/workflows/01-05/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Shopify`, `Amazon`, `Snowflake`, `dbt`, `SFTP`.
...
- **Amazon**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
...
- **SFTP**: Primary operational service responsible for data retrieval, state mutation, or record persistence.

---

## Outputs

- **Primary Action**: Records persisted or state updated across target platforms (Shopify, Amazon).
...
- `Amazon API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
...
- `SFTP API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.

---

## Setup

1. **Import Workflow**: Download [Omnichannel Sales Aggregation & Data Warehousing JSON](../../workflows/01-finops/01_05_omnichannel_sales_aggregation_data_warehousing.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/01-finops/01_05_omnichannel_sales_aggregation_data_warehousing.json)**
