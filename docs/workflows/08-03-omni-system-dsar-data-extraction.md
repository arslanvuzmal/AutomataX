# Omni-System DSAR Data Extraction
...
Executing a Data Subject Access Request (DSAR) requires IT to manually query databases, CRMs, and payment gateways, taking weeks to compile.
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Omni-System DSAR Data Extraction**. 
...
![Workflow Architecture](../../assets/workflows/08-03/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Secure Form`, `Salesforce`, `Stripe`, `AWS`.
...
- **Secure Form**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
...
- **Primary Action**: Records persisted or state updated across target platforms (Secure Form, Salesforce).
...
- `Secure Form API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
...
1. **Import Workflow**: Download [Omni-System DSAR Data Extraction JSON](../../workflows/08-legal-compliance/08_03_omni_system_dsar_data_extraction.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/08-legal-compliance/08_03_omni_system_dsar_data_extraction.json)**
