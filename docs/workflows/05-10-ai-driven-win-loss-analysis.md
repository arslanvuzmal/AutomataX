...
"Price" is the default reason reps choose when they lose a deal. True win/loss analysis requires candid feedback from the prospect themselves.
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **AI-Driven Win/Loss Analysis**. 
...
![Workflow Architecture](../../assets/workflows/05-10/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Salesforce`, `Typeform`, `AI Parser`.
...
- **AI Parser**: Primary operational service responsible for data retrieval, state mutation, or record persistence.

---

## Outputs

- **Primary Action**: Records persisted or state updated across target platforms (Salesforce, Typeform).
...
- `AI Parser API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.

---

## Setup

1. **Import Workflow**: Download [AI-Driven Win/Loss Analysis JSON](../../workflows/05-sales-crm/05_10_ai_driven_win_loss_analysis.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/05-sales-crm/05_10_ai_driven_win_loss_analysis.json)**
