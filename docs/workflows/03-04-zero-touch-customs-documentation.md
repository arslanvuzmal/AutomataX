# Zero-Touch Customs Documentation
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Zero-Touch Customs Documentation**. 
...
![Workflow Architecture](../../assets/workflows/03-04/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `SAP`, `Document Generation API`, `Customs API`.
...
- **SAP**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
- **Document Generation API**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
- **Customs API**: Primary operational service responsible for data retrieval, state mutation, or record persistence.

---

## Outputs

- **Primary Action**: Records persisted or state updated across target platforms (SAP, Document Generation API).
...
- `SAP API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
- `Document Generation API API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
- `Customs API API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.

---

## Setup

1. **Import Workflow**: Download [Zero-Touch Customs Documentation JSON](../../workflows/03-supply-chain/03_04_zero_touch_customs_documentation.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/03-supply-chain/03_04_zero_touch_customs_documentation.json)**
