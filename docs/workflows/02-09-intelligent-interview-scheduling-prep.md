# Intelligent Interview Scheduling & Prep
...
This AutomataX workflow orchestrates an end-to-end automated pipeline for **Intelligent Interview Scheduling & Prep**. 
...
![Workflow Architecture](../../assets/workflows/02-09/architecture.svg)
...
3. **Integration Processing**: Interacts with core services: `Greenhouse`, `Slack`, `Google Calendar`.
...
- **Greenhouse**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
- **Slack**: Primary operational service responsible for data retrieval, state mutation, or record persistence.
- **Google Calendar**: Primary operational service responsible for data retrieval, state mutation, or record persistence.

---

## Outputs

- **Primary Action**: Records persisted or state updated across target platforms (Greenhouse, Slack).
...
- `Greenhouse API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
- `Slack API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.
- `Google Calendar API Credentials`: Scoped access token or OAuth2 credential in n8n Credential Manager.

---

## Setup

1. **Import Workflow**: Download [Intelligent Interview Scheduling & Prep JSON](../../workflows/02-hr/02_09_intelligent_interview_scheduling_prep.json) and import into n8n canvas.
...
📥 **[Download n8n Workflow JSON](../../workflows/02-hr/02_09_intelligent_interview_scheduling_prep.json)**
